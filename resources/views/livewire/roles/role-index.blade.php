<div>
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">{{ __('Roles Management') }}</flux:subheading>
            ...
            <tbody>
                @foreach ($roles as $role)
                    <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                        <td class="px-6 py-2 font-medium text-gray-900 dark:text-gray-950">{{$role->id}}</td>
                        <td class="px-6 py-2 text-gray-600 dark:text-gray-950">{{$role->name}}</td>
                        ...
                        <td class="px-6 py-2">
                            ...
                            @endcan
                            @can('roles.delete')
                            <button wire:click="delete ({{ $role->id }})" wire:confirm="Do you want to delete this role?"
